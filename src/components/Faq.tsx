        ...
        return (
          <div key={i}>
            ...
            >
              ...
              <span
                className={`shrink-0 grid h-7 w-7 place-items-center rounded-full border border-ink/15 text-sage transition-transform duration-300 ${isOpen ? "rotate-45 bg-sage/10" : ""}`}
                aria-hidden="true"
              >
